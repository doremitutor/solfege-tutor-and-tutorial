...
public class UniformPulsesJApplet extends JApplet{
	public void init(){
		UniformPulsesPanel.LANG=Texts.getLang(getParameter("lang"));
		final JApplet applet=this;
		try {
			SwingUtilities.invokeAndWait(new Runnable(){
				public void run(){
					Utilities.setUpApp(applet, null, UniformPulsesPanel.getInstance(false));
				}
			});
